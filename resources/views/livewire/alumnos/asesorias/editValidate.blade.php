            ...
            <table class="table table-condensed table-bordered table-responsive-sm">
                <thead>
                    <tr class="text-white bg-green-600">
                        ...
                        <th class="px-4 py-2">Validación Alumno</th>
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td align="center">
                            <form action="{{ route('AlumnosAsesorias.update',$asesorias->idAsesorias) }}"
                                method="POST">
                                @csrf
                                @method('PUT')
                                @if ($asesorias->ConfirmacionAlumno == '1' )
                                <input type="checkbox" id="cbox2"  checked readonly> <label for="cbox2"></label>

                               
                                @else

                                <input type="checkbox" id="cbox2" name="ConfirmacionAlumno" value="1"> <label for="cbox2"></label>
